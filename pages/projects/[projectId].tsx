      ...
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className="flex flex-col overflow-hidden rounded-lg bg-gray-200 sm:flex-row md:h-80 lg:h-full">
            ...
            <p className="mb-8 max-w-md text-gray-600 font-normal" style={{ fontFamily: "Arial, sans-serif" }}>{project.description}</p>
    ...
    GitHub link
              ...
              <div className="mt-4 flex flex-wrap">
                {project.technologies.map((technology, index) => (
                  <span
                    key={index}
                    className={`text-white px-2 py-1 rounded-lg text-sm font-semibold mr-2 mb-2 ${tagColors[index % tagColors.length]}`}
                  >
                    {technology}
                  </span>
                ))}
